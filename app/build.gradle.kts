...
android {
    ...
    // Lint hataları CI build'ini durdurmasın; hatalar/uyarılar yine de raporlanır
    // (app/build/reports/lint-results-debug.html) ve CI bu raporu artifact olarak
    // yükler, ama build kırmızıya düşmez. Kod kalitesi takibi bu raporlar üzerinden
    // manuel yapılmalı -- bu ayar hataları görünmez kılmaz, sadece build'i bloklamaz.
    lint {
        abortOnError = false
